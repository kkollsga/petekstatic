...
//! [`crate::StaticModelBuilder`] and [`crate::StaticModelTemplate`]
...
/// run resources belong to [`crate::McSettings`] per the suite ruling), and the
/// per-draw scalars (those ride [`crate::RealizationDraw`]).
