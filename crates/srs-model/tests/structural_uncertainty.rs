...
fn mapped(name: &str, depth: f64) -> srs_model::StackHorizon {
    srs_model::StackHorizon {
        name: name.into(),
...
fn stack(top: f64, mid: f64, base: f64) -> HorizonStack {
    HorizonStack {
        ...
        zone_layers: vec![
            srs_model::StackZone::new("Z0", Conformity::Proportional, 4, Vec::new()),
            srs_model::StackZone::new("Z1", Conformity::Proportional, 4, Vec::new()),
        ],
    }
}
...
fn zone0_grv(m: &srs_model::StaticModel) -> f64 {
