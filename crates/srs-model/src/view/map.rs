...
/// [`crate::Provenance::well_ties`] when the model was built with
/// [`crate::StaticModelBuilder::with_well_ties`]; it is empty otherwise.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
pub struct MapBundle {
    ...
    /// [`crate::Provenance::well_ties`] (built via
    /// [`crate::StaticModelBuilder::with_well_ties`]); empty when the model carries
    /// no ties.
