...
//! → wireframe assembly is Phase 3 ([`crate::wireframe`]).

use crate::petekio::{Distribution, Provenance, SummaryInputs, Uncertain};
use srs_wireframe::Hardness;
...
mod tests {
    use super::*;
    use crate::petekio::SummaryInputs;
