...
use crate::pipeline::PropertyReport;
use srs_gridder::{Conformity, SolveOpts};
use srs_wireframe::HorizonRole;
...
pub enum BuildWarning {
    ...
    /// instead of the [`petekstatic_error::StaticError::CrossedSurfaces`] error when the caller
    ...
    LayerCountCapped {
        /// The capped k-layer count (`srs_gridder::MAX_NK`).
        nk: usize,
    },
}
...
/// The record of what produced a [`crate::StaticModel`].
#[derive(Debug, Clone)]
pub struct Provenance {
    ...
    /// one per attached [`crate::PropertyPipeline`]. Empty when no pipeline is
    ...
    /// [`crate::view::IntersectionBundle::sugar_cube`].
    pub sugar_cube: bool,
}
