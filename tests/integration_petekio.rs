...
use petekstatic::data::adapter::ModelScalars;
use petekstatic::data::petekio::{GeoData, GridGeometry, Surface, Unit};
use petekstatic::petro::{upscale_porosity, WeightedSample};
